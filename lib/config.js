...
const DEFAULTS = {
  ...
  editor: 'code',
  // Where version checks and the ccsm package itself come from. npm uses
  // the user's global npm configuration; github uses the npm tarball asset
  // attached to the latest published GitHub Release. Dependencies still
  // resolve through npm in either mode. Never auto-fall back between them.
  updateSource: 'npm',
...
function mergeWithDefaults(partial) {
  ...
  out.updateSource = out.updateSource === 'github' ? 'github' : 'npm';
